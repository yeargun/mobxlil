...
var Atom = class {
   ...
   */
  constructor(name_ = false ? "Atom@" + getNextId4() : "Atom") {
    this.name_ = name_;
  }
  flags_ = 0;
  observers_ = /* @__PURE__ */ new Set();
...
var ObservableValue = class extends Atom {
  constructor(value, enhancer_, name_ = false ? "ObservableValue@" + getNextId5() : "ObservableValue", notifySpy = true, equals_ = compareDefault) {
    super(name_);
