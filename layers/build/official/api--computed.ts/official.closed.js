...
var ObservableMap = class {
  constructor(initialData, enhancer_ = deepEnhancer, name_ = false ? "ObservableMap@" + getNextId6() : "ObservableMap") {
    this.enhancer_ = enhancer_;
    this.name_ = name_;
    initObservable(() => {
...
var ObservableArrayAdministration = class {
  constructor(name = false ? "ObservableArray@" + getNextId7() : "ObservableArray", enhancer, owned_) {
    this.owned_ = owned_;
...
function createObservableArray(initialValues, enhancer, name = false ? "ObservableArray@" + getNextId7() : "ObservableArray", owned = false) {
  return initObservable(() => {
