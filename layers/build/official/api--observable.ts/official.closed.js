...
var ObservableSet = class {
  constructor(initialData, enhancer = deepEnhancer, name_ = false ? "ObservableSet@" + getNextId3() : "ObservableSet") {
    this.name_ = name_;
...
var REMOVE = "remove";
var ObservableObjectAdministration2 = class {
...
Extending builtins is not supported.`
  ...
  const adm = new ObservableObjectAdministration2(
    target,
    /* @__PURE__ */ new Map(),
    String(name),
...
function make_5(adm, key, descriptor) {
  return this.extend_(adm, key, descriptor, false) === null ? 0 /* Cancel */ : 1 /* Break */;
}
